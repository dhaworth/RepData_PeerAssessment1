...
#### Daily Step Total - *Mean:* **`r mean_total_steps_na_removed`** *Median:* **`r median_total_steps_na_removed`**
***
...
```
#### Interval with the maximum value - *Interval:* **`r interval_with_max_steps`** *Steps:* **`r max_steps`**
...
```
#### Total number of NA values in dataset: **`r total_na_count `**
...
```
#### Daily Step Total - *Mean:* **`r mean_total_steps_na_replaced`** *Median:* **`r median_total_steps_na_replaced`**
...
```
#### Differences from NA removed - *Mean Diff:* **`r mean_diff`** *Median Diff:* **`r median_diff`**
